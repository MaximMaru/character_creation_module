...
from graph_arts.start_game_banner import run_screensaver

def attack(char_name: str, char_class: str) -> str:
    """Выполняет атаку персонажа на противника.
    ...
    Returns:
        str: Сообщение о нанесенном уроне противнику.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Выполняет защиту персонажа от атаки противника.
...
def special(char_name: str, char_class: str) -> str:
    """Выполняет специальное умение персонажа.
    ...
    Returns:
        str: Сообщение о примененном специальном умении.
    """
    if char_class == 'warrior':
        return (f'{char_name} '
